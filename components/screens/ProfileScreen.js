...
export default function ProfileScreen() {
  ...
  const [fieldEmail, setFieldEmail] = useState(user.personal_email);
  const [fieldContact, setFieldContact] = useState(user.contact_number);
          ...
          <View className="gap-1 mb-3">
            ...
            >
              ...
              <View>
                ...
                <InputField onChangeText={setFieldEmail} value={fieldEmail} />
              </View>
              <View>
                <Text className="font-archivo-bold text-sm text-[#333]">
                  CONTACT NUMBER
              ...
              <Button
                onPress={async () => {
                  ...
                  await changeUserColumn({
                    ...
                    personal_email: fieldEmail,
                    contact_number: fieldContact,
                  });
                ...
                disabled={
                  (user.anonymous_name == anonyField &&
                    user.personal_email == fieldEmail &&
                    user.contact_number == fieldContact) ||
                  button1 == "Saving"
                }
                value={button1}
              />
          ...
          <View className="gap-1 mb-3">
            ...
            >
              ...
              <Text className="font-archivo text-xs">
                ...
                The platform serves as a wellness support resource and does not
                replace professional psychological, psychiatric, medical, or
                emergency services.
              </Text>
              ...
              <Text className="font-archivo text-xs">
                MoodLink is designed to promote emotional awareness and
                well-being through self-reflection. The mood check-in and
                chatbot features are not psychological, psychiatric, or medical
                assessments and are not intended to diagnose, treat, or evaluate
                any mental health condition. Mood results are generated from
                user responses to support personal emotional awareness and
                should not be interpreted as a professional evaluation. If you
                are experiencing persistent emotional distress, concerns about
                your mental health, or an emergency, you are encouraged to seek
                assistance from the Guidance and Counseling Unit (GCU) or a
              ...
              <Text className="font-archivo text-xs">
                ...
                and are responsible for all activities conducted through their
                accounts.
              </Text>
              ...
              <Text className="font-archivo text-xs">
                ...
                following content is prohibited: harassment, bullying, threats,
                hate speech, discriminatory remarks, offensive, obscene, or
                inappropriate content, false or misleading information,
                defamatory statements, content promoting self-harm, violence,
                illegal activities, or any content that violates school
                policies. Users remain responsible for the content they post.
              </Text>
              ...
              <Text className="font-archivo text-xs">
                ...
                accounts that violate these Terms and Conditions, abuse platform
                services, or engage in harmful, disruptive, or inappropriate
                behavior.
              </Text>
              ...
              <Text className="font-archivo text-xs">
                ...
                provide emergency mental health services, and should not be
                relied upon during crisis situations requiring immediate
                professional assistance. Students experiencing emergencies
                should contact appropriate emergency services, the Guidance and
                Counseling Unit, or qualified professionals immediately.
              </Text>

              <Text className="font-archivo-bold text-sm">11. Amendments</Text>
